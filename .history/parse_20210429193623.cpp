...
#define STAT_FIRST KW_WHILE, KW_DO, KW_SWITCH, KW_CASE, KW_DEFAULT, KW_IF, KW_FOR, KW_SECLOUD, KW_READ, KW_WRITE, \
KW_RETURN, KW_BREAK, KW_CONTINUE, SEMICON, EXPR_FIRST
...
void Parser::varlist(Tag t, bool ext)
{
    ...
    else
    {
        ...
        {
            recovery(isInFollow(FOLLOW{KW_EXTERN, RBRACE, TYPE_FIRST, STAT_FIRST}), SEMICON_LOST);
        }
    }
}

...
void Quaternion::toString()
{
    ...
    else if(op == OP_RET) printf("OP_RET return point is %s", fun->getReturnPoint()->label.c_str());
    else if(op == OP_RETX) printf("OP_RETX return value is"), arg1->info(), printf(" point is %s", fun->getReturnPoint()->label.c_str());
